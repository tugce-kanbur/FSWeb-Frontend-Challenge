        ...
        <section className="bg-primary dark:bg-[#171043] w-[1440px] h-[552px] pt-[50px] pb-[120px] px-[239px] text-white font-Inter">
            ...
            <div className="items-start w-[960px] h-[290.68px] flex gap-[30px]">
                <div className="bg-primary dark:bg-[#171043] w-[300px] h-[290.68px] rounded-[10px] p-4">
                    <p className="w-[300px] text-white text-[30px] leading-[28px] font-medium font-Inter mb-5">
                ...
                <div className="w-[300px] h-[290.68px] rounded-[10px] overflow-hidden">
                    <img src={about.image} alt="Çalışma ortamı" className="w-[300px] h-[290.68px] rounded-[10px] shadow-[0_18px_88px_-4px_rgba(24,39,75,0.14)] shadow-[0_8px_28px_-6px_rgba(24,39,75,0.12)]" />
                </div>
                <div className="bg-primary dark:bg-[#171043] w-[300px] h-[290.68px] rounded-[10px] p-4">
                    <p className="w-[300px] text-white text-[30px] leading-[100%] font-medium font-Inter mb-5">
                        {about.title[language]}
                    </p>
                    {about.paragraphs.map((p, i) => (
                        <p key={i} className="w-[300px] text-white text-[18px] leading-[140%] font-normal font-Inter mb-4">
                            {p[language]}
                        </p>
                    ))}
                </div>
