...
function Header() {
    ...
    return (
        <header className="flex justify-between items-center px-0 mb-10 py-6">
            <p className="text-2xl font-bold text-secondary">almila</p>
            ...
            <div className="flex items-center gap-4 translate-x-[185px] translate-y-[-30px]">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-[#8F88FF] rounded-full 
                         dark:bg-gray-700 peer-checked:after:translate-x-full 
                        rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white 
                         after:absolute after:top-0.5 after:start-[2px] after:bg-[#FFE86E] dark:after:bg-white
                    ...
                    <span className="ml-2 text-sm font-medium text-primary dark:text-gray-300">
                        {isEnglish ? "DARK MODE" : "KARANLIK MOD"}
                    </span>
                </label>
            </div>
        </header>
