...
export default function Hero() {
    ...
    return (
        <section className="w-[1376px] h-[671px] flex font-Inter">
            <div className="hidden lg:flex flex-row min-w-[1376px] min-h-[671px]">
            ...
            <div className="block lg:hidden">
                <div className="bg-primary dark:bg-[#171043] text-white px-6 py-12">
                    <Header />
                    <h1 className="text-3xl font-bold mt-6 text-secondary dark:text-[#CBF281] leading-tight">
                        {heroData.heading[language]}
                    </h1>
                    <h1 className="text-3xl font-bold mt-4 text-secondary dark:text-[#CBF281] leading-tight">
                        {heroData.heading1[language]}
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4 mt-6">
                        {heroData.buttons.map((btn, index) => (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-[10px] px-[20px] py-[12px] border border-[#3730A3] dark:border-white rounded-[6px] text-[#3730A3] dark:text-white bg-white dark:bg-[#252128] text-base font-medium hover:bg-indigo-50 transition"
                            >
                                <img
                                    src={darkMode ? btn.iconDark : btn.iconLight}
                                    alt={btn.label[language]}
                    ...
                    <div className="flex justify-center mt-8">
                        <img
                            src={heroData.image}
                            alt="Hero"
                            className="w-[220px] h-auto rounded-md shadow-md"
                        />
                    </div>
                </div>
            </div>
